...
Application::Application(int& argc, char** argv) : QApplication(argc, argv)
{
    ...
    // Initialize application settings
    {
        ...
        m_settings->registerSetting("ApplicationTheme", QString("racked.ru"));
        m_settings->registerSetting("BackgroundCat", QString("racked_ru"));
        ...
        // Memory
        m_settings->registerSetting({ "MinMemAlloc", "MinMemoryAlloc" }, 384);
    ...
    // Instance icons
    {
        ...
        QStringList instFolders = { ":/icons/racked_ru/32x32/instances/", ":/icons/racked_ru/50x50/instances/",
                                    ":/icons/racked_ru/128x128/instances/", ":/icons/racked_ru/scalable/instances/" };
...
MainWindow* Application::showMainWindow(bool minimized)
{
    if (m_mainWindow) {
        ...
        if (auto* newsBar = m_mainWindow->findChild<QToolBar*>("newsToolBar")) {
            newsBar->hide();
            newsBar->toggleViewAction()->setChecked(false);
        }
